...
import com.example.onlinepathshala.Authority.Transaction;
...
public class Accountant_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acountant__dashboard);
            ...
            holder.card1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(position==0){
                        ...
                        startActivity(new Intent(getApplicationContext(),Accountant_Profiile.class));
                    }
                    else if(position==1){
