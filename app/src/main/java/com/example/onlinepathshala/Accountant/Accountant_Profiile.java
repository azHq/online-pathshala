...
public class Accountant_Profiile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accountant__profiile);
        ...
        progressDialog=new ProgressDialog(Accountant_Profiile.this);
    ...
    public void showEditDialog(final String column_name, String title, String hint) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Accountant_Profiile.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            CropImage.activity(imageUri)
                    .start(Accountant_Profiile.this);
