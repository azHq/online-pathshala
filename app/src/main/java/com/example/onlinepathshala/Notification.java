...
import com.example.onlinepathshala.Student.Student_Routine;
import com.example.onlinepathshala.Student.Up_Coming_Exam;
import com.example.onlinepathshala.Teacher.Assign_HomeTask;
import com.example.onlinepathshala.Teacher.Routine_View;
...
public class Notification extends Fragment {
    ...
    public  Notification(FragmentManager fragmentManager){
            ...
            holder.item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(MainActivity.countTextView!=null&&MainActivity.countTextView.getText()!=null&&!MainActivity.countTextView.getText().toString().equalsIgnoreCase("")){
                        int count=0;
                        if(Integer.parseInt(MainActivity.countTextView.getText().toString())>0&&memberInfo.status.equalsIgnoreCase("0")){
                    ...
                    if(memberInfo.notification_type.equalsIgnoreCase("Routine")) changeFragmentView(new Student_Routine());
                    else if(memberInfo.notification_type.equalsIgnoreCase("Result")) changeFragmentView(new Result());
                    else if(memberInfo.notification_type.equalsIgnoreCase("Notice")) changeFragmentView(new Notice());
                    else if(memberInfo.notification_type.equalsIgnoreCase("Home Task")) changeFragmentView(new Home_Task());
                    else if(memberInfo.notification_type.equalsIgnoreCase("Exam")) changeFragmentView(new Up_Coming_Exam());
