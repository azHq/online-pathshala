...
public class Teacher_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showEditDialog("teacher_name","Edit User Name",name);
            }
        });
        ...
        progressDialog=new ProgressDialog(Teacher_Profile.this);
    ...
    public void showEditDialog(final String column_name, String title, String hint) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Teacher_Profile.this);
