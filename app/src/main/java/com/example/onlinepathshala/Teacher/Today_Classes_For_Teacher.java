...
public class Today_Classes_For_Teacher extends Fragment {

    ActionBar actionBar;
    public Today_Classes_For_Teacher(ActionBar actionBar) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_today__classes__for__teacher, container, false);
    ...
    public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.ViewAdapter>{
        ...
        public  class ViewAdapter extends RecyclerView.ViewHolder{
            ...
            TextView teacher_name,subject_name,start_time,end_time;
